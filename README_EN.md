...
Claude Code generates a response using Cook's mental models (text)
    ↓
VoxCPM2 clones Cook's voice from real reference audio (speech synthesis)
    ↓
...
1. Kill products that don't meet the bar (Project Titan: 10 years, $10B → axed)
2. Short-term controversy vs. long-term brand? Choose brand (FBI, ATT)
3. When attacked, redefine the battlefield (Congressional hearing 4-step deflection)
4. Start premium, then expand down (Apple Watch, Vision Pro)
...
8. "Follow local laws" as the bottom-line framework for compromise
...
| File | Contents | Lines |
|------|----------|-------|
| `01-writings.md` | Writings & systematic thinking | 149 |
...
| `05-decisions.md` | Major decision analysis (13 decisions) | 675 |
...
VoxCPM2 handles the last mile: turning text into voice, bringing the distilled persona truly to life.
...
│   ├── cook_tts_20260408_innovation.mp4  # Example: "lack of disruptive innovation"
│   └── cook_tts_20260408_141622.mp4      # Example: same question, different response
├── references/
